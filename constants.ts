...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    longDescription: 'ArchSphere is an independent product concept designed for the architecture industry, exploring how architects, projects, ideas, and professional workflows can exist within a unified digital ecosystem. The project focuses on creating a visually engaging and intuitive experience for discovering, organizing, and interacting with architectural work.',
  ...
  },
  {
    id: '5',
    title: 'Cactus Coffee',
    description: 'An independent e-commerce concept designed around intuitive product discovery and online shopping.',
